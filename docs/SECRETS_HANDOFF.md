...
- (New) Machine-to-machine credentials generated by bootstrap: `LOGTO_M2M_CLIENT_ID` / `LOGTO_M2M_CLIENT_SECRET` (used for smoke tests and API probes).
...
export LOGTO_M2M_CLIENT_ID="$(grep '^LOGTO_M2M_CLIENT_ID=' .env.local.generated | cut -d= -f2-)"
export LOGTO_M2M_CLIENT_SECRET="$(grep '^LOGTO_M2M_CLIENT_SECRET=' .env.local.generated | cut -d= -f2-)"
