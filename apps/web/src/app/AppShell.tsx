...
import type { Hotspot, StarfieldVariant } from './components/Starfield';
...
const AppShell = ({ navItems, activeItem, onNavigate, companies, isLoadingCompanies, children }: AppShellProps) => {
  ...
  return (
    <View className="flex min-h-screen flex-row bg-surface">
      <View className="hidden w-72 border-r border-slate-900/30 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 lg:flex">
        <div
          ref={(node) => {
