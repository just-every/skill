    ...
    <View className="min-h-screen bg-[#f7f3ec] text-[#211c17]">
      <View className="border-b border-[#e5ddd1] bg-[#f8f5ef]/95">
        <View className="mx-auto flex w-full max-w-[1200px] flex-row items-center justify-between gap-4 px-4 py-3 md:px-8 md:py-4">
          <Pressable onPress={() => navigate('/')} className="flex-row items-center gap-3">
          ...
          <View className="hidden flex-row items-center gap-7 md:flex">
            {navItems.map((item) => {
              ...
              return (
                <Pressable key={item.label} onPress={() => navigate(item.to)}>
          ...
          <View className="flex-row items-center gap-2 md:gap-3">
            <Pressable
              ...
              className="rounded-xl border border-[#d9cfbf] bg-[#f8f5ef] px-3 py-2 md:px-4"
            >
              <Text className="text-xs font-semibold text-[#3e352b] md:text-sm">Browse</Text>
            </Pressable>
            <Pressable onPress={() => navigate('/skills')} className="rounded-xl bg-[#174f87] px-3 py-2 md:px-4">
              <Text className="text-xs font-semibold text-white md:text-sm">View Rankings</Text>
            </Pressable>
          </View>
        </View>
      </View>
