...
3. **Bootstrap CLI** – Only provisions Cloudflare and Stripe resources. Better Auth stays external; env scaffolding ensures the new auth variables reach `.env.local.generated`, `workers/api/.dev.vars`, and Expo runtimes.
